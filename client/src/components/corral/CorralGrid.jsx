...
const getCellKey = (fila, col) => `${fila}-${col}`;
        ...
        {filas.map((fila, filaIndex) => (
          ...
          >
            ...
            {columnas.map((col, colIndex) => {
              ...
              const isDisabled = isOccupied || isAlternaBloqueada;
              ...
              const occupiedClass =
                "cursor-not-allowed border-red-200 bg-red-100 text-red-600 opacity-90";
              ...
              return (
                ...
                >
                  ...
                  {!isSelected && isAlternaBloqueada && (
                    <Lock className="h-4 w-4 text-[#6B7280]/55" />
                  )}
                </button>
              );
            })}
