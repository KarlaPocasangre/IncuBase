    ...
    <main className="flex min-h-screen items-center justify-center bg-[#EEF3F0] px-4 py-8">
      <section className="relative w-full max-w-[560px] overflow-hidden rounded-[28px] border border-white/70 bg-white px-8 py-10 text-center shadow-[0_24px_70px_rgba(22,56,50,0.18)]">
        ...
        <div className="relative z-10">
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#163832]/10 text-[#163832]">
            <AlertTriangle size={42} strokeWidth={2.2} />
          </div>

          <p className="mb-2 text-[13px] font-bold uppercase tracking-[0.28em] text-[#163832]/70">
            Error 404
          </p>
          ...
          <p className="mx-auto mt-3 max-w-[390px] text-[14px] leading-6 text-gray-500">
            La ruta que intentas visitar no existe, fue movida o está escrita
            incorrectamente.
          </p>
